...
@property (readonly, strong, nonatomic) SSModelController *modelController;
@end
...
- (SSModelController *)modelController
{
     // Return the model controller object, creating it if necessary.
     // In more complex implementations, the model controller may be passed to the view controller.
    if (!_modelController)
    {
        _modelController = [[SSModelController alloc] initWithPages: @[
                            @"SSNavigationStripTestViewController",
                            @"SSTabViewTestViewController"]
                            ];
    }
